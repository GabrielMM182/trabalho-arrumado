...
<body>
  ...
  <section class="container-fluid">
    <div class="row bg-dark text-white">
        ...
        <div id="carouselCidades" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="img/coxinha.jpg" class="d-block w-100" alt="...">
              <div class="carousel-caption">
                <h3 class="display-4">Boa igual aquela que você come em festa de criança</h3>
              </div>
            ...
            <div class="carousel-item">
              ...
              <div class="carousel-caption">
                <h3 class="display-4">Depois que sai da academia e quer comer sem pesar o treino ( ͡° ͜ʖ ͡°)</h3>
              </div>
            </div>
          </div>
      ...
      <div class="col-lg-5 p-4 align-self-center">
        <h1 class="display-4">O principal da lanchonete que todo mundo gosta <b>SALGADOS</b></h1>
        <p class="lead">Feito com os melhores ongredientes para atender a nossa clientela</p>
        <p class="lead"></p>Aqui na TECHLANCHE você encontra todo tipo de salgado, do lanche natural até a coxinha</p>
        <form action="">
  ...
  <div class="my-5 text-center">
    ...
    <h2 class="display-4 text-primary">a lista de todos os salgados</h2>
  </div>
      ...
      <div class="col-4">
        <div class="list-group" id="list-tab" role="tablist">
          <a class="list-group-item list-group-item-action active" id="list-salgado1-list" data-toggle="list"
            href="#list-salgado1" role="tab" aria-controls="salgado1">COXINHA</a>
          <a class="list-group-item list-group-item-action " id="list-salgado2-list" data-toggle="list"
            href="#list-salgado2" role="tab" aria-controls="salgado2">LANCHE NATURAL DE ATUM</a>
          <a class="list-group-item list-group-item-action " id="list-salgado3-list" data-toggle="list"
            href="#list-salgado3" role="tab" aria-controls="salgado3">ESFIRRA DE CARNE</a>
          <a class="list-group-item list-group-item-action " id="list-salgado4-list" data-toggle="list"
            href="#list-salgado4" role="tab" aria-controls="salgado4">LANCHE COM QUEIJO E BACON</a>
          <a class="list-group-item list-group-item-action " id="list-salgado5-list" data-toggle="list"
            href="#list-salgado5" role="tab" aria-controls="salgado5">PIZZA DE CALABREZA</a>
      ...
      <div class="col-8">
        <div class="tab-content" id="nav-tabContent">
          <div class="tab-pane fade show active" id="list-salgado1" role="tabpanel"
            aria-labelledby="list-salgado1-list">coxinha com uma casquinha crocante e com um frango bem temperado, que
            combinação perfeita em <b>VALOR: R$4,00</b> <button type="button"
              class="btn btn-outline-success">Comprar</button> </div>
          <div class="tab-pane fade " id="list-salgado2" role="tabpanel" aria-labelledby="list-salgado2-list">aquele
            lanche clássico e saudavel que todo mundo gosta de comer <b>VALOR: R$5,00</b> <button type="button"
              class="btn btn-outline-success">Comprar</button> </div>
          <div class="tab-pane fade " id="list-salgado3" role="tabpanel" aria-labelledby="list-salgado3-list">um salgado
            que sempre tem nas festas uma esfirra de carne bem temperada para você sobreviver o restante das aulas
            <b>VALOR: R$ 3,50</b> <button type="button" class="btn btn-outline-success">Comprar</button> </div>
          <div class="tab-pane fade" id="list-salgado4" role="tabpanel" aria-labelledby="list-salgado4-list">pense bem
            uma carne suculenta + queijo derretendo + BACON esse salgado é perfeito <b>VALOR: R$4,50</b> <button
              type="button" class="btn btn-outline-success">Comprar</button> </div>
          <div class="tab-pane fade" id="list-salgado5" role="tabpanel" aria-labelledby="list-salgado5-list">sabe aquele
            ditado "tudo acaba em pizza..." então ele faz sentido <b>VALOR: R$ 2,50</b> <button type="button"
              class="btn btn-outline-success">Comprar</button> </div>
        </div>
      </div>
    </div>
